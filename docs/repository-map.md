...
| `SocialWill/` | 72 | small | Good candidate for normal Git tracking |
...
- `UtilWeDie-Neo-1.21.1/ModsSourceCode/`: many mod porting workspaces. Prefer tracking only actively maintained fork/port directories, not downloaded upstream archives, decompiled output, or build folders.
