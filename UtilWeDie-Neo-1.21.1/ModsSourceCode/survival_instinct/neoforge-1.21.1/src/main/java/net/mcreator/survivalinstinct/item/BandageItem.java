...
import net.mcreator.survivalinstinct.procedures.BandagePlayerFinishesUsingItemProcedure;
...
extends Item {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        list.add((Component)Component.literal((String)" \u00a79Regeneration II for 40 seconds"));
    }
    ...
    public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
        ...
        BandagePlayerFinishesUsingItemProcedure.execute((Entity)entity);
        return retval;
    }
}
