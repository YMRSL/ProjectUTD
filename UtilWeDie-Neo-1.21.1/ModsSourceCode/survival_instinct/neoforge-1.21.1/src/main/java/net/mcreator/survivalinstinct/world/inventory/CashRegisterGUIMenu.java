...
public class CashRegisterGUIMenu
...
implements Supplier<Map<Integer, Slot>> {
    ...
    public CashRegisterGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)SurvivalInstinctModMenus.CASH_REGISTER_GUI.get(), id);
        int si;
        ...
        this.customSlots.put(0, this.addSlot((Slot)new SlotItemHandler(this.internal, 0, 8, 35)));
        this.customSlots.put(1, this.addSlot((Slot)new SlotItemHandler(this.internal, 1, 26, 35)));
        this.customSlots.put(2, this.addSlot((Slot)new SlotItemHandler(this.internal, 2, 44, 35)));
        this.customSlots.put(3, this.addSlot((Slot)new SlotItemHandler(this.internal, 3, 62, 35)));
        this.customSlots.put(4, this.addSlot((Slot)new SlotItemHandler(this.internal, 4, 80, 35)));
        this.customSlots.put(5, this.addSlot((Slot)new SlotItemHandler(this.internal, 5, 98, 35)));
        this.customSlots.put(6, this.addSlot((Slot)new SlotItemHandler(this.internal, 6, 116, 35)));
        this.customSlots.put(7, this.addSlot((Slot)new SlotItemHandler(this.internal, 7, 134, 35)));
        this.customSlots.put(8, this.addSlot((Slot)new SlotItemHandler(this.internal, 8, 152, 35)));
        for (si = 0; si < 3; ++si) {
