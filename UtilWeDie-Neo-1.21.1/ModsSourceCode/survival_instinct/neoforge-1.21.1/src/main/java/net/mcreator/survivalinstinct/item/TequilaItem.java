...
import net.mcreator.survivalinstinct.procedures.TequilaPlayerFinishesUsingItemProcedure;
...
extends Item {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        list.add((Component)Component.literal((String)" \u00a79Strenght I for 30 seconds and Nausea II for 8 seconds"));
    }
    ...
    public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
        ...
        TequilaPlayerFinishesUsingItemProcedure.execute((Entity)entity);
