...
import net.mcreator.survivalinstinct.procedures.BeerPlayerFinishesUsingItemProcedure;
...
extends Item {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        list.add((Component)Component.literal((String)" \u00a79Nausea I for 8 seconds"));
    }
    ...
    public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
        ...
        BeerPlayerFinishesUsingItemProcedure.execute((Entity)entity);
