...
public class RefrigeratorGUIScreen
extends AbstractContainerScreen<RefrigeratorGUIMenu> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        guiGraphics.drawString(this.font, (Component)Component.translatable((String)"gui.survival_instinct.refrigerator_gui.label_refrigerator"), 6, 6, -12829636, false);
        guiGraphics.drawString(this.font, (Component)Component.translatable((String)"gui.survival_instinct.refrigerator_gui.label_inventory"), 6, 72, -12829636, false);
    }
