...
implements Supplier<Map<Integer, Slot>> {
    ...
    public EmptyBagGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)SurvivalInstinctModMenus.EMPTY_BAG_GUI.get(), id);
        int si;
