...
import net.mcreator.survivalinstinct.procedures.WinePlayerFinishesUsingItemProcedure;
...
extends Item {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
        ...
        list.add((Component)Component.literal((String)" \u00a79Regeneration I for 30 seconds and Nausea I for 8 seconds"));
    }
    ...
    public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
        ...
        WinePlayerFinishesUsingItemProcedure.execute((Entity)entity);
