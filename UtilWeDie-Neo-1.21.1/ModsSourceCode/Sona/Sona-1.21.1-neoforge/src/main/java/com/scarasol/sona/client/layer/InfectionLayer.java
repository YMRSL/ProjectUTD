...
public class InfectionLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("sona", "textures/entity/layer/spore_layer.png");
        ...
        if (!livingEntity.isInvisible()) {
            if (livingEntity instanceof ILivingEntityAccessor livingEntityAccessor) {
                ...
                if (livingEntityAccessor.getInfectionLayer()) {
                    ...
                    // 1.21.1: renderToBuffer color is a packed ARGB int (alpha,r,g,b -> FastColor.ARGB32.colorFromFloat).
                    int color = FastColor.ARGB32.colorFromFloat(
                            livingEntityAccessor.getCamouflageAlpha(), 1.0F, 1.0F, 1.0F);
