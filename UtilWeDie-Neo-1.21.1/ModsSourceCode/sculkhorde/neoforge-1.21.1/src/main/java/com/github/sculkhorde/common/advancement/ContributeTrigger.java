...
public class ContributeTrigger extends SimpleCriterionTrigger<ContributeTrigger.ContributeCriterion> implements CustomCriterionTrigger{
     ...
     */
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(SculkHorde.MOD_ID, "contribute_trigger");
    ...
    public record ContributeCriterion(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance {

        public static final Codec<ContributeCriterion> CODEC = RecordCodecBuilder.create(
                instance -> instance.group(
                        EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(ContributeCriterion::player)
