...
public class FerrisciteHoeItem extends HoeItem implements IHealthRepairable {
    ...
    protected static Properties PROPERTIES = new Properties()
            ...
            .rarity(Rarity.EPIC)
            .durability(3000)
            .attributes(HoeItem.createAttributes(Tiers.IRON, ATTACK_DAMAGE, ATTACK_SPEED));
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        {
            tooltip.add(Component.translatable("tooltip.sculkhorde.ferriscite_hoe.functionality"));
        }
        else if(InputConstants.isKeyDown(Minecraft.getInstance().getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_CONTROL))
        {
            tooltip.add(Component.translatable("tooltip.sculkhorde.ferriscite_hoe.lore"));
        }
        else
        {
