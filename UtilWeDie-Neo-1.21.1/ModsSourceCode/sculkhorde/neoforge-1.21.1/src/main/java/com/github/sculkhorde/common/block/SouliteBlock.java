...
public class SouliteBlock extends HalfTransparentBlock {
    ...
    @Override
    protected net.minecraft.world.ItemInteractionResult useItemOn(net.minecraft.world.item.ItemStack itemInHand, BlockState blockState, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult blockHitResult) {
        if(itemInHand.isEmpty())
        {
            return net.minecraft.world.ItemInteractionResult.FAIL;
        }

        if(itemInHand.is(ModItems.PURE_SOULS.get()))
        {
