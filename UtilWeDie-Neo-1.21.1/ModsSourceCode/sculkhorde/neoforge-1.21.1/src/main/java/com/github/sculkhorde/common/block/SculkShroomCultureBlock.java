...
public class SculkShroomCultureBlock extends SculkFloraBlock {
    ...
    public static final MapCodec<SculkShroomCultureBlock> CODEC = simpleCodec(SculkShroomCultureBlock::new);
    @Override
    public MapCodec<? extends SculkShroomCultureBlock> codec() { return CODEC; }
