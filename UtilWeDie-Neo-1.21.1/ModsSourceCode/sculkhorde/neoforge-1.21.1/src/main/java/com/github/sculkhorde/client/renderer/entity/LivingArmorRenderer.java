...
public class LivingArmorRenderer extends GeoEntityRenderer<LivingArmorEntity> {
    ...
    public void preRender(PoseStack poseStack, LivingArmorEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
