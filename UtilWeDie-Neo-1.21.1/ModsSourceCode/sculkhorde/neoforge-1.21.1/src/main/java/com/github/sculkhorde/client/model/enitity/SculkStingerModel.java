...
public class SculkStingerModel extends DefaultedEntityGeoModel<SculkStingerEntity> {
    ...
    @Override
    public RenderType getRenderType(SculkStingerEntity animatable, ResourceLocation texture) {
