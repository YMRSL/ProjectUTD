...
public class SculkSquidEntity extends WaterAnimal implements GeoEntity, ISculkSmartEntity {
    ...
    class AttackInfectAndBlindGoalLegacy extends LegacyCustomMeleeAttackGoal
    {
        ...
        protected void checkAndPerformAttack(LivingEntity targetMob, double distanceFromTargetIn) {
            ...
            {
                EntityAlgorithms.applyEffectToTarget(targetMob, ModMobEffects.SCULK_INFECTION, TickUnits.convertSecondsToTicks(30), SculkHorde.gravemind.getPotionAmplificationBasedOnGravemindState());
                spawnInk();
            }
            else
            {
