...
public class FerrisciteAxeItem extends AxeItem implements IHealthRepairable {
    protected static float ATTACK_SPEED = -3.1F;
    protected static int ATTACK_DAMAGE = 6;
    ...
    protected static Properties PROPERTIES = new Properties()
            ...
            .rarity(Rarity.EPIC)
            .durability(3000)
            .attributes(AxeItem.createAttributes(Tiers.IRON, ATTACK_DAMAGE, ATTACK_SPEED));
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        {
            tooltip.add(Component.translatable("tooltip.sculkhorde.ferriscite_axe.functionality"));
        }
        else if(InputConstants.isKeyDown(Minecraft.getInstance().getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_CONTROL))
        {
            tooltip.add(Component.translatable("tooltip.sculkhorde.ferriscite_axe.lore"));
        }
        else
        {
