...
public class SculkSheepEntity extends Monster implements GeoEntity, ISculkSmartEntity {
     ...
     */
    public SculkSheepEntity(EntityType<? extends SculkSheepEntity> type, Level worldIn) {
        super(type, worldIn);
