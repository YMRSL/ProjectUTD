...
public class SculkGhastWanderGoal extends Goal {
    ...
    // Fields
    private final SculkGhastEntity mob;
    ...
    public SculkGhastWanderGoal(SculkGhastEntity mob, double speedModifier, long interval, int maxHeightOffGround) {
        this.mob = mob;
