...
public class JEISculkHordePlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<SoulHarvestingRecipe> soulHarvestingRecipes = recipeManager.getAllRecipesFor(SoulHarvestingRecipe.Type.INSTANCE).stream().map(net.minecraft.world.item.crafting.RecipeHolder::value).toList();
