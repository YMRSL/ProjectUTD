...
public class ModStructures {
    ...
    public static final DeferredHolder<StructureType<?>, StructureType<SculkTombStructure>> SCULK_TOMB_STRUCTURE = STRUCTURES.register("sculk_tomb_structure", () -> explicitStructureTypeTyping(SculkTombStructure.CODEC));
    ...
    private static DeferredHolder<StructurePieceType, StructurePieceType> registerStructurePiece(String name, StructurePieceType structurePieceType) {
