...
public class SculkVexEntity extends Monster implements GeoEntity, ISculkSmartEntity {
    ...
    @Override
    public EntityDimensions getDefaultDimensions(Pose p_260180_) {
        EntityDimensions p_260049_ = super.getDefaultDimensions(p_260180_);
        return p_260049_.withEyeHeight(p_260049_.height() - 0.28125F);
    }
