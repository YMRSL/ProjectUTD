...
// 注意: 不要加 @EventBusSubscriber —— 本类无 @SubscribeEvent 方法, NeoForge 会因
// "register 了无监听方法的类" 而抛 IllegalArgumentException。标签页通过 TABS(DeferredRegister)
// + displayItems 内联注册, 不需订阅事件。
