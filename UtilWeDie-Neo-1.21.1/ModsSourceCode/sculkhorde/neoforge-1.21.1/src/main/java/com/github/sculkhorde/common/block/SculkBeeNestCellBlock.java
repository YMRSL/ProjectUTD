...
public class SculkBeeNestCellBlock extends BaseEntityBlock {
    ...
    public static final MapCodec<SculkBeeNestCellBlock> CODEC = simpleCodec(SculkBeeNestCellBlock::new);
    @Override
    public MapCodec<? extends SculkBeeNestCellBlock> codec() { return CODEC; }
    /**
    ...
    @Override
    protected net.minecraft.world.ItemInteractionResult useItemOn(ItemStack itemstack, BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit)
    {
        if (isMature(pState))
        {
            if (itemstack.getItem() == Items.SHEARS)
            {
                ...
                itemstack.hurtAndBreak(1, pPlayer, net.minecraft.world.entity.LivingEntity.getSlotForHand(pHand));
