...
public class SoulIceProjectileRenderer extends GeoEntityRenderer<SoulIceProjectileAttackEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, SoulIceProjectileAttackEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        poseStack.pushPose();
