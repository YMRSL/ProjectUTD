...
public class SmallBroodAcidProjectileEntity extends AbstractProjectileEntity implements GeoEntity {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if(entityHitResult.getEntity() instanceof LivingEntity livingEntity)
        {
            ...
            livingEntity.addEffect(new MobEffectInstance(new MobEffectInstance(ModMobEffects.CORRODED, TickUnits.convertSecondsToTicks(30))));
        }
    }
    ...
    private void spawnLingeringCloud() {
        ...
        areaeffectcloud.addEffect(new MobEffectInstance(new MobEffectInstance(ModMobEffects.CORRODED, TickUnits.convertSecondsToTicks(30), 1)));
