...
public class SpikeBlock extends SculkFloraBlock {

    public static final MapCodec<SpikeBlock> CODEC = simpleCodec(SpikeBlock::new);
    @Override
    public MapCodec<? extends SpikeBlock> codec() { return CODEC; }
   ...
   // public static Effect INFECT_EFFECT = EffectRegistry.SCULK_INFECTION.get();
    ...
    public void entityInside(BlockState blockState, Level world, BlockPos blockPos, Entity entity) {
        ...
        if(EntityAlgorithms.isInvalidTargetForSculkHorde((LivingEntity) entity))
        {
            return;
        }
        ...
        if (entity.xOld != entity.getX() || entity.zOld != entity.getZ())
        {
            ...
            if (d0 >= (double)0.003F || d1 >= (double)0.003F)
            {
                ...
                EntityAlgorithms.applyEffectToTarget(((LivingEntity) entity), ModMobEffects.SCULK_INFECTION, INFECT_DURATION, INFECT_LEVEL);
            }
        }
