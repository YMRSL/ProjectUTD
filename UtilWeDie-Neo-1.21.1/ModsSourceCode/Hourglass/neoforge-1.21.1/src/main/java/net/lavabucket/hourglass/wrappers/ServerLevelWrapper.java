...
public class ServerLevelWrapper extends Wrapper<ServerLevel> {
    ...
    public void setSleepStatus(SleepStatus newStatus) {
        // ServerLevel.sleepStatus is exposed via accesstransformer.cfg.
        this.get().sleepStatus = newStatus;
    }
    ...
    public void tickBlockEntities() {
        // Level.tickBlockEntities() is exposed via accesstransformer.cfg.
        this.get().tickBlockEntities();
    }
