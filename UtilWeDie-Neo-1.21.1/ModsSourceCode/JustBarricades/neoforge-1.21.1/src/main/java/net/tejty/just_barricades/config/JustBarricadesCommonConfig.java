...
public class JustBarricadesCommonConfig {
    ...
    public static final ModConfigSpec.DoubleValue DROP_REPAIR_ITEM_CHANCE;
    public static final ModConfigSpec.DoubleValue ZOMBIE_BREAK_CHANCE;
    public static final ModConfigSpec.BooleanValue REPAIR_AFTER_ZOMBIE;
    public static final ModConfigSpec.BooleanValue PLAYER_CAN_BREAK_COMPLETELY;

    static {
        BUILDER.push("Config for Just Barricades");

        REPAIR_ITEM = BUILDER.comment("The id of item that will be required for repairing. Leave blank for no item requirement").define("repair_item", "minecraft:stick", JustBarricadesCommonConfig::validateItemNameOrBlank);
    ...
    private static boolean validateItemNameOrBlank(final Object obj) {
