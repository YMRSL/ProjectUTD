...
**发布状态（2026-07-13）：** `0.1.6-test6` 已通过实机验收；`0.1.10-test10` 在 test9 的全量图标/变体修复基础上，读取 `item_properties.json` 部署账本，并在 O 界面检查器和 Tooltip 中以 `R/B/T/F` 显示稀有度、占格、枪械与食品属性纳管状态。
