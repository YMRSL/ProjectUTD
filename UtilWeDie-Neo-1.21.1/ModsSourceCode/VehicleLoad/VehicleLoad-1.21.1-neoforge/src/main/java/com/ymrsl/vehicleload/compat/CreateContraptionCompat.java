...
public final class CreateContraptionCompat {
    ...
    private static boolean init() {
        ...
        try {
            ...
            // 1.21.1 (Mojmap): Entity#getViewYRot(float)/getViewXRot(float), overridden by OrientedContraptionEntity.
            orientedYawMethod = orientedContraptionEntityClass.getMethod("getViewYRot", float.class);
            orientedPitchMethod = orientedContraptionEntityClass.getMethod("getViewXRot", float.class);
        } catch (ReflectiveOperationException e) {
