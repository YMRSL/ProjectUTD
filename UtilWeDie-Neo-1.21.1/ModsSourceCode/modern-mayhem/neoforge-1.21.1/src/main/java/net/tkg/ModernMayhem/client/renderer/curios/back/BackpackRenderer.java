...
extends GeoArmorRenderer<BackpackItem>
implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull((ResourceLocation)this.getTextureLocation(((BackpackItem)stack.getItem()))));
    ...
    public static class BackpackSlotRenderer
    extends GeoItemRenderer<BackpackItem> {
        public BackpackSlotRenderer() {
            super((GeoModel)new BackpackModels());
        }
    }
}
