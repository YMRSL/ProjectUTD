...
public class HeadGearRenderer
extends GeoArmorRenderer<HeadGearItems>
implements ICurioRenderer {
    public HeadGearRenderer() {
        super((GeoModel)new HeadGearModel());
    }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull((ResourceLocation)this.getTextureLocation(((HeadGearItems)stack.getItem()))));
    ...
    public static class HeadGearItemRenderer
    extends GeoItemRenderer<HeadGearItems> {
        public HeadGearItemRenderer() {
            super((GeoModel)new HeadGearModel());
        }
    }
}
