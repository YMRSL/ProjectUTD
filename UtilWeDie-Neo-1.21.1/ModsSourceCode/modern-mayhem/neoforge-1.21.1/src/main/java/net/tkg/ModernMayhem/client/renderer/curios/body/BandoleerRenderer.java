...
public class BandoleerRenderer
extends GeoArmorRenderer<BandoleerItem>
implements ICurioRenderer {
    public BandoleerRenderer() {
        super((GeoModel)new BandoleerModel());
    }
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        VertexConsumer consumer = renderTypeBuffer.getBuffer(RenderType.armorCutoutNoCull((ResourceLocation)this.getTextureLocation(((BandoleerItem)stack.getItem()))));
    ...
    public static class BandoleerSlotRenderer
    extends GeoItemRenderer<BandoleerItem> {
        public BandoleerSlotRenderer() {
            super((GeoModel)new BandoleerModel());
        }
    }
}
