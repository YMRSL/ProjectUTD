...
public class ItemRoachBurger extends Item {
    public ItemRoachBurger() {
        super(new Properties().food(new FoodProperties.Builder().nutrition(12).build()));
    }
    ...
    public ItemStack finishUsingItem(ItemStack pStack, Level pLevel, LivingEntity pLivingEntity) {
        ...
        Datas.removeEffectIf(pLivingEntity, 2, MobEffects.POISON);
