...
public class WrenchRenderer extends EntityRenderer<WrenchEntity> {
    private static final ResourceLocation texture = ResourceLocation.parse("zombiekit:textures/entities/monkey_wrench.png");
    ...
    public void render(WrenchEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        model.renderToBuffer(poseStack, vb, packedLightIn, OverlayTexture.NO_OVERLAY, FastColor.ARGB32.colorFromFloat(0.0625f, 1, 1, 1));
        poseStack.popPose();
