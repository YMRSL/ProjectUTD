...
public class ZombieKitDamageTypes {
    ...
    public static final ResourceKey<DamageType> BARBED_WIRE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("zombiekit:barbed_wire"));
    public static final ResourceKey<DamageType> HEAVY_MACHINE_GUN = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("zombiekit:heavy_machine_gun"));
    public static final ResourceKey<DamageType> HEAVY_MACHINE_GUN_BYPASS_ARMOR = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("zombiekit:heavy_machine_gun_bypass_armor"));
    public static final ResourceKey<DamageType> WRENCH = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("zombiekit:wrench"));
