...
public class UvLampEntity extends Mechanics{
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(hasBattery, false);
        builder.define(power, 0);
        builder.define(lightswitch, false);
        ...
        for (Mob entityIterator : entFound) {
            if (entityIterator.getType().is(EntityTypeTags.UNDEAD) || CommonConfig.findIndex(BuiltInRegistries.ENTITY_TYPE.getKey(entityIterator.getType()).toString(), CommonConfig.INFECTION_SOURCE_MOB.get()) != -1){
                ...
                if (com.scarasol.zombiekit.config.CommonConfig.HIGH_PERFORMANCE_MODE.get()){
                    entityIterator.addEffect(new MobEffectInstance(SonaMobEffects.IGNITION, 20, 2, false, false));
                }
                ...
                entityIterator.addEffect(new MobEffectInstance(SonaMobEffects.FRAGILITY, 20, 2, false, false));
