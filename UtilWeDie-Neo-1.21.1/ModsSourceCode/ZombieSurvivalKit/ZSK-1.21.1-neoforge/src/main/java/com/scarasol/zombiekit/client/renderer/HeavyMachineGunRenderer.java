...
public class HeavyMachineGunRenderer extends GeoEntityRenderer<HeavyMachineGunEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, HeavyMachineGunEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
        float scale = 1f;
