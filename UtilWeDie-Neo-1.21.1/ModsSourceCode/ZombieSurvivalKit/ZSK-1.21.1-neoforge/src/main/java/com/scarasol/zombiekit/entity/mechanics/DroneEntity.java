...
public class DroneEntity extends Mechanics{
        ...
        if (!isNoGravity() && !this.level().isClientSide()){
            if (itemstack.is(ZombieKitItems.WRENCH.get())){
                if (player.isShiftKeyDown()){
                    ...
                    this.level().playSound(null, this, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("zombiekit:drone_switch")), SoundSource.HOSTILE, 0.3F, 1F);
                }
            }else {
    ...
    public void tick() {
        if (getTarget() == null && isNoGravity()) {
            this.level().playSound(null, this, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("zombiekit:drone_idle")), SoundSource.HOSTILE, 0.05F, 1F);
            if (hoverPlace == null){
        ...
        if (this.hasEffect(SonaMobEffects.SLIMINESS)){
    ...
    public SoundEvent getDeathSound() {
        return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("zombiekit:drone_crush"));
    }
