...
public class TacticalSuitModel<T extends Entity> extends AbstractArmorModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("zombiekit", "modeltactical_suit"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		LeftShoes.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		RightShoes.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
}
