...
public class UvLampRenderer extends MobRenderer<UvLampEntity, UVlampModel<UvLampEntity>> {
    ...
    public ResourceLocation getTextureLocation(UvLampEntity entity) {
        if(entity.getPower() > 75 && entity.isHasBattery())return ResourceLocation.parse("zombiekit:textures/entities/uv_lamp_o1.png");
        else if(entity.getPower() > 50 && entity.isHasBattery())return ResourceLocation.parse("zombiekit:textures/entities/uv_lamp_o2.png");
        else if(entity.getPower() > 25 && entity.isHasBattery())return ResourceLocation.parse("zombiekit:textures/entities/uv_lamp_o3.png");
        else if(entity.isHasBattery())return ResourceLocation.parse("zombiekit:textures/entities/uv_lamp_o4.png");
        else return ResourceLocation.parse("zombiekit:textures/entities/uv_lamp_o5.png");
    }
}
