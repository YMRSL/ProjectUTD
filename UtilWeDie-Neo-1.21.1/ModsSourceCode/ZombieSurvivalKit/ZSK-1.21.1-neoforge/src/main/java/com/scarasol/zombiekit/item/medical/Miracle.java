...
public class Miracle extends Item {
    ...
    public void addEffects(LivingEntity livingEntity){
        int i = livingEntity.hasEffect(SonaMobEffects.IMMUNITY) ? livingEntity.getEffect(SonaMobEffects.IMMUNITY).getAmplifier() + 1 : 0;
        livingEntity.addEffect(new MobEffectInstance(SonaMobEffects.IMMUNITY, 6000, i, false, true));
