...
public class VacuumPackagingMachineMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public VacuumPackagingMachineMenu(int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
        this(id, inv, extraData.readBlockPos(), new SimpleContainerData(2));
    }

    public VacuumPackagingMachineMenu(int id, Inventory inv, BlockPos pos, ContainerData dataAccess) {
        ...
        this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 31, 21) {
            ...
            public boolean mayPlace(ItemStack stack) {
                return RotManager.isEdible(stack);
            }
        }));
