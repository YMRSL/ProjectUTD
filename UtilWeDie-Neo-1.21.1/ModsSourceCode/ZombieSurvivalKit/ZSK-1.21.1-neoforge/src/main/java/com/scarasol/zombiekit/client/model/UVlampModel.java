...
public class UVlampModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("zombiekit", "model_u_vlamp"), "main");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		lamp2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		lamp3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
