...
public class MortarEntity extends Mechanics implements GeoEntity, FixedVehicle {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(ANGLE, -45f);
        builder.define(AZIMUTH, 0f);
        builder.define(TEXTURE, "mortar");
        builder.define(SHELL, "Empty");
    ...
    public Item getShell() {
        ...
        return BuiltInRegistries.ITEM.get(ResourceLocation.parse(str));
    }
    ...
    public void setShell(@Nullable Item item) {
        ...
        setShell(BuiltInRegistries.ITEM.getKey(item).toString());
    }
