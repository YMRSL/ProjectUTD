...
public class CommonConfig {
    ...
    public static final ModConfigSpec.ConfigValue<Double> BASEBALL_BAT_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> STUDDED_BASEBALL_BAT_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_BASEBALL_BAT_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> BASEBALL_BAT_SPEED;

    public static final ModConfigSpec.ConfigValue<Double> CHAINSAW_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Integer> CHAINSAW_POWER;


    public static final ModConfigSpec.ConfigValue<Double> CROWBAR_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_CROWBAR_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> CROWBAR_SPEED;

    public static final ModConfigSpec.ConfigValue<Double> FIRE_AXE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_FIRE_AXE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> FIRE_AXE_SPEED;

    public static final ModConfigSpec.ConfigValue<Double> KNIFE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_KNIFE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> TRIANGULAR_THORN_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> KNIFE_SPEED;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_KNIFE_SPEED;
    public static final ModConfigSpec.ConfigValue<Double> ASSASSINATE_MULTIPLIER;

    public static final ModConfigSpec.ConfigValue<Double> MACHETE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_MACHETE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> MACHETE_SPEED;

    public static final ModConfigSpec.ConfigValue<Double> RAKE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_RAKE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> RAKE_SPEED;
    public static final ModConfigSpec.ConfigValue<Double> RAKE_RANGE_INCREASE;
    public static final ModConfigSpec.ConfigValue<Double> NETHERITE_RAKE_RANGE_INCREASE;

    public static final ModConfigSpec.ConfigValue<Double> WRENCH_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Integer> WRENCH_COOLDOWN;

    public static final ModConfigSpec.ConfigValue<Integer> FUEL_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Integer> NAPALM_FUEL_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Integer> HIGH_TEMPERATURE_FUEL_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> FUEL_CONSUME;

    public static final ModConfigSpec.ConfigValue<Boolean> FLY_FUNCTION;
    public static final ModConfigSpec.ConfigValue<Integer> EXO_HUD_WIDTH;
    public static final ModConfigSpec.ConfigValue<Integer> EXO_HUD_HEIGHT;

    public static final ModConfigSpec.ConfigValue<Double> DAMAGE_COEFFICIENT;

    public static final ModConfigSpec.ConfigValue<Boolean> SWEEP;
    public static final ModConfigSpec.ConfigValue<Double> SWEEP_MULTIPLIER;

    public static final ModConfigSpec.ConfigValue<Integer> BANDAGE_INJURY;
    public static final ModConfigSpec.ConfigValue<Integer> BANDAGE;

    public static final ModConfigSpec.ConfigValue<Integer> MEDICAL_INJURY;
    public static final ModConfigSpec.ConfigValue<Integer> MEDICAL_BANDAGE;

    public static final ModConfigSpec.ConfigValue<Integer> SUSPICIOUS_HEAL;
    public static final ModConfigSpec.ConfigValue<Double> SUSPICIOUS_SIDE_EFFECTS;

    public static final ModConfigSpec.ConfigValue<Integer> ENERGY_ROD_CHARGE;

    public static final ModConfigSpec.ConfigValue<Integer> WARHEAD_NUMBER;

    public static final ModConfigSpec.ConfigValue<Integer> SIGNAL_RANGE;

    public static final ModConfigSpec.ConfigValue<Boolean> LANDMINE_CHAIN;
    public static final ModConfigSpec.ConfigValue<Integer> CHAIN_RANGE;

    public static final ModConfigSpec.ConfigValue<Integer> RADAR_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> RADAR_POWER;

    public static final ModConfigSpec.ConfigValue<Double> BROKEN_CHANCE;

    public static final ModConfigSpec.ConfigValue<Integer> CHARGING_RATE;

    public static final ModConfigSpec.ConfigValue<Double> ILLAGER_CHANCE;
    public static final ModConfigSpec.ConfigValue<Integer> ILLAGER_NUMBER;
    public static final ModConfigSpec.ConfigValue<Double> VINDICATOR_CHANCE;

    public static final ModConfigSpec.ConfigValue<Integer> HEAVY_MACHINE_GUN_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Double> ARMOR_PIERCING_RATE;
    public static final ModConfigSpec.ConfigValue<Boolean> IGNORING_INVULNERABILITY;

    public static final ModConfigSpec.ConfigValue<Boolean> HIGH_PERFORMANCE_MODE;
    public static final ModConfigSpec.ConfigValue<Integer> LAMP_POWER;

    public static final ModConfigSpec.ConfigValue<Boolean> MORTAR_BREAK_BLOCK;
    public static final ModConfigSpec.ConfigValue<Integer> MORTAR_EXPLOSION_LEVEL;
    public static final ModConfigSpec.ConfigValue<Integer> NAPALM_DAMAGE;
    public static final ModConfigSpec.ConfigValue<Integer> NAPALM_BURN_TIME;
    public static final ModConfigSpec.ConfigValue<Integer> NAPALM_RANGE;

    public static final ModConfigSpec.ConfigValue<Boolean> RAIDER_INDEPENDENCE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ILLAGER_WHITELIST;
    public static final ModConfigSpec.ConfigValue<Double> EQUIPMENT_INITIALIZATION;
    public static final ModConfigSpec.ConfigValue<Double> BOMB_ARMOR_INITIALIZATION;
    ...
    static {
        ...
        ILLAGER_WHITELIST = BUILDER.comment("Monsters that don't hostile to illagers.")
                .defineList("Illager Whitelist", Arrays.asList("savageandravage:creepie", "minecraft:vex"), () -> "", Objects::nonNull);
