...
public class MortarShellRenderer extends GeoEntityRenderer<MortarShellEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MortarShellEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
