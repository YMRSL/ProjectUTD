...
public class FreezingBattleParts extends BattleParts {
    ...
    public void partsEffect(LivingEntity attacker, LivingEntity target, float damage) {
        ...
        float actualDamage;
        int amplifier = (target.hasEffect(SonaMobEffects.FROST.get())) ? target.getEffect(SonaMobEffects.FROST.get()).getAmplifier() : -1;
        int duration;
        ...
        target.addEffect(new MobEffectInstance(SonaMobEffects.FROST.get(), duration, amplifier, false, false));
