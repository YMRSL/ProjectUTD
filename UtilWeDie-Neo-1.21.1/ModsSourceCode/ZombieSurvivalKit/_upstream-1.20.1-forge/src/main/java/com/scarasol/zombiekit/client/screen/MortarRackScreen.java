...
public class MortarRackScreen extends AbstractContainerScreen<MortarRackMenu> {
    ...
    private static final ResourceLocation shooting_parameters_table_slot = new ResourceLocation("zombiekit:textures/screens/gui/shooting_parameters_table_slot.png");
